import { PlayerFeatureBlock } from "@/features/Shared/components/PlayerFeatureBlock";
...
export const ResultCard = ({ item, onClick }: Props) => {
  return (
    ...
    >
      ...
      <div className="mt-8 py-6 px-4 rounded-lg bg-gohan/[0.67]">
        <PlayerFeatureBlock title="Passing" value="90" />
        <PlayerFeatureBlock title="Strength" value="70" />
      </div>
    </div>
  );
};
